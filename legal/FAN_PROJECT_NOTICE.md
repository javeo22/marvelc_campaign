...
The companion is designed to track fan-campaign progress and assist physical table play. It does not provide a complete playable copy of the game. Card metadata or externally hosted images may be unavailable or disabled at any time. Rights holders and service operators may contact **[TAKEDOWN CONTACT]** regarding attribution, linking, or removal.

Do not state that this notice itself grants permission or establishes fair use.
